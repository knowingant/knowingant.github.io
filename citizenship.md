---
layout: page
title: Minnesota citizenship
permalink: /citizenship/
---

I'm from Minnesota, so I run Minnesota citizenship exams.
Minnesota citizenship includes a miniature Minnesota state flag
and a certificate of citizenship.

<div style="display: flex; justify-content: center; gap: 20px; align-items: center;">
  <img src="/assets/images/evan-citizenship.jpeg"
  alt="Evan Chen holding Minnesota state flag" width="45%">
  <img src="/assets/images/minnesota-certificate.png"
  alt="Minnesota citizenship certificate" width="45%">
</div>

If you see me in-person and want Minnesota citizenship,
