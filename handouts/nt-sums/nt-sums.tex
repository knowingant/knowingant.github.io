...
\begin{solution}{\Cref{pro:cmimc-2020}}
	...
	Although we do know something about the summation function of $g$, we don't know much about $g$ itself. Therefore, we're motivated to use M\"obius inversion. Define $G(n) = \sum_{d \mid n}g(d)$, so $G(n) = 0$ for all non-prime $n$. Now we see
