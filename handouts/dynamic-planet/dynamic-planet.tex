...
\begin{figure}[H]
	...
	\caption{The Norwegian adaptation of \emph{The Sword in the Stone} takes things in a weird direction. Source: \url{https://www.xkcd.com/2164}.}
\end{figure}
...
\begin{itemize}
	...
	\ii The \emph{zone of fracture} is above $50$ meters. It's when ice fractures. Produces crevasses; their depth is restricted to $50$ meters.
	\ii The \emph{zone of accumulation} is the area where more snow falls each winter than melts in the summer. The \emph{zone of wastage/ablation} is the opposite; the line dividing the two is called the \emph{snowline/equilibrium line}. The \emph{glacial budget} is whether a glacier is retreating, advancing, or at equilibrium.
	\ii Glaciers erode by \emph{plucking} and \emph{abrasion}. Plucking occurs when meltwater pulls rock loose by freezing under a rock. Abrasion occurs when stone is scratched by plucked stones; this produces \emph{rock flour} (which is unfortunately not edible). \emph{Glacial striations} are large scratches produced in bedrock by huge ice fragments' abrasion; they are linear and help one to reconstruct the direction of glacial flow.
\end{itemize}
...
\begin{itemize}
	\ii A \emph{glacial trough} or a \emph{glaciated valley} is a U-shaped valley. 
	...
	\ii A \emph{col} is a pass formed when two cirques meet. An \emph{ar\^ete} is a ridge formed when two cirques meet. A \emph{horn} is a peak formed when three cirques meet. Example: the Matterhorn.
	...
	\ii A \emph{fjord} is a glacial trough flooded by seawater, either due to sea-level rise or because glaciers eroded below sea level.
\end{itemize}
...
\begin{itemize}
	\ii An \emph{outwash plain} (ice sheet) or a \emph{valley train} (valley glacier) is a ramp-like feature just outside an end moraine formed by sand or gravel that is deposited quickly as meltwater slows.
...
Here are the ice-contact ones. Ice-contact deposits form on top of a glacier, then get dropped when the glacier melts.
\begin{itemize}
	\ii A \emph{kame} is a mound or steep-sided hill, formed by deposited sediment in a delta, fan, or an opening in the ice.
...
\begin{itemize}
	\ii Your mother (very heavy) stands on a trampoline, and it sinks. When she leaves, the trampoline slowly returns to its original position. This is \emph{isostatic rebound}, but your mother is an ice-age glacier and the trampoline is the Earth's crust. It's still rebounding from the Last Glacial Maximum.
	...
	\ii The colder climate in ice ages produces \emph{pluvial lakes}, which are fed by rain. (The colder climate reduces evaporation.) Lake Bonneville was a pluvial lake comparable to Lake Michigan. The Great Salt Lake is its residue.
...
\begin{itemize}
	\ii \textbf{Glacier formation.} The crystal structure of ice is shown in \Cref{fig:ice_crystal}. N\'ev\'e is relatively new snow which melts a little, refreezes a little, and gets compacted a little. Once it survives for a year, it becomes firn. After firn gets buried by $50$ meters of snow, it becomes glacial ice. The zones of ablation and accumulation are where a glacier is net losing/gaining ice, respectively; the equilibrium line separates them. Basal sliding is when the entire glacier slides along the bottom; plastic flow is like a very viscous liquid flowing.
	\begin{figure}[H]
		\centering
	...
	\ii \textbf{Features in glacial ice.} A crevasse is a crack in the ice above $50$ meters, created by internal forces to the ice. An icefall is an area of a glacier that is steep and moves much faster than the surrounding areas, like an ice stream but steeper and within alpine glaciers.
	...
	\begin{figure}[H]
		...
		\caption{Formation of open (left) and closed (right) system pingos. A \emph{talik} is an area of unfrozen ground covered by permafrost.}
		\label{fig:pingo}
	\end{figure}
	...
	\ii \textbf{Methods of studying glaciers and interpretation of related data.} All the standard survey techniques, plus gravimetry, which is measuring the strength of a gravitational field (!!). Ice cores can be used for radiometric dating, analysis of the amount of snow each year (colors give summer/winter cycles), temperature history (oxygen isotope analysis), relative humidity, wind speed (from deuterium isotope analysis), history of cosmic rays (from beryllium-10), and paleoatmospheric analysis.
...
\begin{itemize}
	...
	\ii Ice sheets currently cover around $10\%$ of Earth's land area. Ice sheets covered around $8\%$ of the Earth and $25\%$ of its land area during the Last Glacial Maximum.
...
\begin{itemize}
	\ii The Milankovitch cycles eccentricity, obliquity (degree of tilt), and precession (direction of tilt) have periods of 100,000 years, 41,000 years, and 26,000 years, respectively.\footnote{From \url{https://science.nasa.gov/science-research/earth-science/milankovitch-orbital-cycles-and-their-role-in-earths-climate/}.}
	\ii Snowball Earth (if it occurred) most likely occurred 550 to 725 million years ago during the Neoproterozoic.
	\ii The Eocene--Oligocene extinction event occurred 34 million years ago.
	...
	\ii The Last Glacial Maximum was from 26,000 to 20,000 years ago.
	\ii Lake Agassiz existed from 12,000 to 7500 years ago.
\end{itemize}
