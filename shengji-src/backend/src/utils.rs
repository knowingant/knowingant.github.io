...
/// Write the state dump atomically: a crash (or a `SIGKILL` halfway through)
/// leaves the previous dump intact rather than a truncated file.
            ...
            move |versioned_game| {
                ...
                Ok((
                    VersionedGame {
                        ...
                        reset_votes: versioned_game.reset_votes,
                    },
                    msgs,
                ))
            },
    ...
    let res = backend_storage
        ...
        .execute_operation_with_messages::<EitherError<E>, _>(
            ...
            move |versioned_game| {
                ...
                let mut reset_votes = versioned_game.reset_votes;
