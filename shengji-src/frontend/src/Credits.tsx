      ...
      >
        ...
        <ul>
          ...
          <li>
            ...
            default, changeable in the game settings). The first round of a
            match only starts once <em>every</em> player has clicked start; the
            match ends the moment someone reaches the target rank, and everyone
            goes back to rank 2.
          </li>
          <li>
            Rated matches: rooms are rated by default, and a rated match moves
            an Elo-style rating once, when it ends, by an amount that depends on
            the ratings involved and the final margin (see RATINGS.md). Two
            ladders, team and 1v1, with a leaderboard on the landing page.
            Rounds are never rated on their own.
          </li>
          <li>
            Rounds now end by themselves as soon as the cards left can&apos;t
            change the result and the bottom holds no points, so the manual
            &ldquo;end game early&rdquo; button is gone.
          </li>
          <li>
            Account pages: per-player ratings, statistics and match history.
            Click any player&apos;s name to open theirs.
          </li>
          <li>
            1v1 rooms: exactly two people, each playing both seats of a team,
            rated on their own ladder.
          </li>
          <li>
            New defaults: fast autodraw, no taking back bids or plays, and the
            bottom penalty is 2^n (n = the size of the largest component of the
            last trick). All are still room settings; only the defaults changed.
          </li>
          <li>
            Removed Sentry error reporting and the upstream social metadata.
          </li>
        </ul>
        <p>3/18/2026:</p>
        <ul>
...
const Credits = (): JSX.Element => (
  <div className="credits">
    <p>
      ...
      <a
        href="https://robertying.com/shengji/"
        target="_blank"
        rel="noreferrer"
      >
